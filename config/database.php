	...
	*/
	...
	'connections' => [
		...
		'mysql' => [
			...
			'database'  => env('DB_DATABASE', env('OPENSHIFT_APP_NAME', 'pettracker')),
			'username'  => env('DB_USERNAME', env('OPENSHIFT_MYSQL_DB_USERNAME', 'pettracker')),
			'password'  => env('DB_PASSWORD', env('OPENSHIFT_MYSQL_DB_PASSWORD', 'pettracker')),
			'charset'   => 'utf8',
